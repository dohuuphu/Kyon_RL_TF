...
def conv2d(inputs, kernel_size, filters, stride, activation=None, use_bias=True, weight_init=tf.keras.initializers.glorot_normal, bias_init=tf.zeros_initializer(), scope='conv'):
...
def dense(inputs, output_size, activation=None, weight_init=tf.keras.initializers.glorot_normal, bias_init=tf.zeros_initializer(), scope='dense'):
    with tf.variable_scope(scope):
